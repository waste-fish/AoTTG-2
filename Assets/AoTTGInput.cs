// GENERATED AUTOMATICALLY FROM 'Assets/AoTTGInput.inputactions'
...
public class @AoTTGInput : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Fire"",
                    ""type"": ""Button"",
                    ""id"": ""341cbd20-a869-492e-80d7-51e93a22e3d7"",
    ...
    {
        private @AoTTGInput m_Wrapper;
        public PlayerActions(@AoTTGInput wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @AoTTGInput m_Wrapper;
        public UIActions(@AoTTGInput wrapper) { m_Wrapper = wrapper; }
